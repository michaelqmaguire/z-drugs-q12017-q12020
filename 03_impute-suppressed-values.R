#-----------------------------------------------------------------------------------------------------------------#
#                                                                                                                 #
# PROJECT: SDUD Z-DRUGS 2005 - 2010	                                                                              #
...
fwrite(x = drugsAggStateImputed, file = "./data/clean/05_imputed-z-drugs-2015-2020-aggregate-by-state.csv", na = "")
fwrite(x = drugsAggStateGenericImputed, file = "./data/clean/06_imputed-z-drugs-2015-2020-aggregate-by-state-and-generic.csv", na = "")
fwrite(x = drugsAggStateProdnmeImputed, file = "./data/clean/07_imputed-z-drugs-2015-2020-aggregate-by-state-generic-and-brand.csv", na = "")
